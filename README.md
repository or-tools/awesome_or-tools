...
- [LLMに数理最適化モデルを書かせるときの「もっともらしい間違い」をどう検出するか](https://qiita.com/koshoshiyuji/items/af3eb69e3e81e586b0c6) How to detect subtly wrong optimization models generated by an LLM, in a platform using OR-Tools CP-SAT as its default solver. (Japanese)
